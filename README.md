...
**NOTE**: There's a couple typos in the Appendix of [Shread et al. 2026](https://doi.org/10.3847/1538-4357/ae644c): the selection logic is as written in this code base, which lives primarily in GroupFinderCore.cpp. Namely, Eq. A24 should be P >= f_C B, not P >= 1/3 f_C B.
